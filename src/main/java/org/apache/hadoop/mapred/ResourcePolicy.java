      ...
      for (Offer offer : offers) {
        ...
        overrides.set("mapred.child.java.opts",
            scheduler.conf.get("mapred.child.java.opts") +
                " -XX:+UseConcMarkSweepGC -XX:+CMSIncrementalMode -XX:+CMSParallelRemarkEnabled -XX:TargetSurvivorRatio=40 -XX:NewRatio=2 -XX:ParallelGCThreads=2 -XX:+AggressiveOpts -XX:+UseCompressedOops -XX:+UseFastEmptyMethods -XX:+UseFastAccessorMethods -Xmx" + slotJVMHeap + "m -Xms" + slotJVMHeap + "m -Xss256k -XX:+UseLargePages -XX:+AlwaysPreTouch");
